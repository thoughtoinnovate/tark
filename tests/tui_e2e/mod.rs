...
impl TuiTestHarness {
    ...
    pub fn when_key_pressed(&mut self, code: KeyCode) -> &mut Self {
        self.key_queue.push_back(KeyEvent::new(code, KeyModifiers::NONE));
        self.process_key_queue();
        self
    }

    /// Simulate pressing a key with modifiers
    pub fn when_key_pressed_with_modifiers(&mut self, code: KeyCode, modifiers: KeyModifiers) -> &mut Self {
