...
mod tests {
    ...
    fn test_status_bar_setters() {
        ...
        status.set_mode(AgentMode::Review);
        assert_eq!(status.mode, AgentMode::Review);
    ...
    fn test_agent_mode_display() {
        ...
        assert_eq!(AgentMode::Review.display_name(), "Review");
    }
    ...
    fn test_agent_mode_icon() {
        ...
        assert_eq!(AgentMode::Review.icon(), "○");
    }
