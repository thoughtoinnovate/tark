...
if ! tty -s; then
    ...
    echo "Solutions:"
    echo ""
    echo "1. If in Docker, run with -it flags:"
    echo "   docker exec -it <container> bash"
    echo "   # Then run: cd /home/dev/data/work/code/tark && ./run_tui.sh"
    echo ""
    echo "2. If SSH'd, connect with -t flag:"
    echo "   ssh -t user@host"
    echo ""
    echo "3. Use non-TUI chat mode instead:"
    echo "   ./target/release/tark chat"
    echo ""
    echo "4. Use script to create a pseudo-terminal:"
